...
namespace Iot.Device.Adc
{
    ...
    public class Ina219 : IDisposable
    {
        ...
        public ElectricPotential ReadShuntVoltage() => ElectricPotential.FromVolts(ReadRegister(Ina219Register.ShuntVoltage, (int)(GetResolutionSample((Ina219AdcResolutionOrSamples)_shuntAdcResSamp) * 10.0 / 1000000.0)));
        ...
        public ElectricPotential ReadBusVoltage() => ElectricPotential.FromVolts(((short)ReadRegister(Ina219Register.BusVoltage, GetResolutionSample(_busAdcResSamp) >> 3) * 4 / 1000.0));
        ...
        public ElectricCurrent ReadCurrent()
        {
            ...
            return ElectricCurrent.FromAmperes(ReadRegister(Ina219Register.Current, (int)(GetResolutionSample(_shuntAdcResSamp) * _currentLsb)));
        }
        ...
        public Power ReadPower()
        {
            ...
            return Power.FromWatts(ReadRegister(Ina219Register.Power, (int)(GetResolutionSample(_shuntAdcResSamp) * _currentLsb * 20)));
        }
        ...
        private int GetResolutionSample(Ina219AdcResolutionOrSamples sample) 
	    {
            switch (sample)
            {
                case Ina219AdcResolutionOrSamples.Adc9Bit:
                    return 84;
                case Ina219AdcResolutionOrSamples.Adc10Bit:
                    return 148;
                case Ina219AdcResolutionOrSamples.Adc11Bit:
                    return 276;
                case Ina219AdcResolutionOrSamples.Adc12Bit:
                    return 532;
                case Ina219AdcResolutionOrSamples.Adc2Sample:
                    return 1006;
                case Ina219AdcResolutionOrSamples.Adc4Sample:
                    return 2130;
                case Ina219AdcResolutionOrSamples.Adc8Sample:
                    return 4260;
                case Ina219AdcResolutionOrSamples.Adc16Sample:
                    return 8510;
                case Ina219AdcResolutionOrSamples.Adc32Sample:
                    return 17020;
                case Ina219AdcResolutionOrSamples.Adc64Sample:
                    return 34050;
                case Ina219AdcResolutionOrSamples.Adc128Sample:
                    return 68100;
                default:
                    return 0;
            }        
