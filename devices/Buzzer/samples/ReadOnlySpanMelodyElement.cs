...
namespace System
{
    ...
    internal readonly ref struct ReadOnlySpanMelodyElement
    {
        ...
        public ReadOnlySpanMelodyElement(MelodyElement[]? array)
        {
            _array = array;
        ...
        //
        // Summary:
        //     Creates a new System.ReadOnlySpan`1 object from a specified number of MelodyElement elements starting
        //     at a specified memory address.
        //
        // Parameters:
        //   pointer:
        //     A pointer to the starting address of a specified number of MelodyElement elements in memory.
        //
        //   length:
        //     The number of MelodyElement elements to be included in the System.ReadOnlySpan`1.
        //
        // Exceptions:
        //   T:System.ArgumentException:
        //     MelodyElement is a reference type or contains pointers and therefore cannot be stored in
        //     unmanaged memory.
        //
        //   T:System.ArgumentOutOfRangeException:
        //     length is negative.
        //[CLSCompliant(false)]
        //public ReadOnlySpanMelodyElement(void* pointer, int length);
        ...
        /// </exception>
        public ReadOnlySpanMelodyElement(MelodyElement[]? array, int start, int length)
        {
            if (array != null)
            {
        ...
        /// </summary>
        public static ReadOnlySpanMelodyElement Empty => new ReadOnlySpanMelodyElement();
        ...
        public ReadOnlySpanMelodyElement Slice(int start)
        {
            ...
            return new ReadOnlySpanMelodyElement(_array, start, Length - start);
        }
        ...
        public ReadOnlySpanMelodyElement Slice(int start, int length)
        {
            ...
            return new ReadOnlySpanMelodyElement(_array, start, length);
        }
        ...
        {
            MelodyElement[] array = new MelodyElement[Length];
